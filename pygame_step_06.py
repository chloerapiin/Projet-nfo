...
#FPS : nombre de fois ou l'écran va se refresh, donc 12 pixels par seconde

#dans cette classe création de l'attribut horloge, qui permet de dire 12 photo par secondre
