...
#il change à chaque fois de vitesse
...
class App:
    ...
    def __init_actors(self) -> None:
        ...
        actor_02: Actor = Actor(pygame.Vector2(210, 160), pygame.Vector2(0, 0), (60, 40)) #Actor(pygame.Vector2(300, 300), pygame.Vector2(200,200), (20,20))
        ...
        ActorSpriteDrivenByRandom(actor_02, "magenta", [self.__actors_sprites])
